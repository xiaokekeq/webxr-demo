...
export function getARDomElements(): ARDomElements {
	...
	return {
		...
		mobilePreArDisplayModeSelectEl: getElement( 'mobile-pre-ar-display-mode-select' ) as HTMLSelectElement,
		...
		browseLayerListEl: getElement( 'browse-layer-list' ),
		...
		registrationRepositionButton: getElement( 'registration-reposition' ) as HTMLButtonElement,
		registrationClearSavedButton: getElement( 'registration-clear-saved' ) as HTMLButtonElement,
		...
		toolsMeasureButton: getElement( 'tools-measure-distance' ) as HTMLButtonElement,
		toolsHeightMeasureButton: getElement( 'tools-measure-height' ) as HTMLButtonElement,
		toolsDeltaMeasureButton: getElement( 'tools-measure-delta' ) as HTMLButtonElement,
		toolsClearButton: getElement( 'tools-measure-clear' ) as HTMLButtonElement,
		toolsCaptureButton: getElement( 'tools-capture-current' ) as HTMLButtonElement,
		toolsInfoCaptureButton: getElement( 'tools-capture-info' ) as HTMLButtonElement,
		toolsAnnotateButton: getElement( 'tools-annotate' ) as HTMLButtonElement,
		toolsControlPointsButton: getElement( 'tools-control-points' ) as HTMLButtonElement,
		inspectionCurrentNameEl: getElement( 'inspection-current-name' ),
		inspectionCurrentTypeEl: getElement( 'inspection-current-type' ),
		inspectionCurrentStatusEl: getElement( 'inspection-current-status' ),
		inspectionResultEl: getElement( 'inspection-result' ) as HTMLSelectElement,
		...
		inspectionExportButton: getElement( 'inspection-export' ) as HTMLButtonElement,
